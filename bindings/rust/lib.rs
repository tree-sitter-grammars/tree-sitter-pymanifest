...
extern "C" {
    fn tree_sitter_pymanifest() -> Language;
}
...
pub const HIGHLIGHTS_QUERY: &'static str = include_str!("../../src/tree_sitter_pymanifest/queries/highlights.scm");
